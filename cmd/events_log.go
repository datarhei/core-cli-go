...
func parseLogFilter(args []string) ([]string, api.LogEventFilter, bool) {
	if len(args) == 0 {
		return nil, api.LogEventFilter{}, true
	}

	filter := api.LogEventFilter{
		Component: args[0],
...
func init() {
	eventsCmd.AddCommand(eventsLogCmd)
}
