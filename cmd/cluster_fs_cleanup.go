...
var clusterFilesystemCleanupCmd = &cobra.Command{
...
func init() {
	clusterFilesystemCmd.AddCommand(clusterFilesystemCleanupCmd)

	clusterFilesystemCleanupCmd.Flags().BoolP("execute", "x", false, "Actually execute the cleanup")
}
